...
const dict = {
  nl: {
    ...
    locationDenied: "Locatie geweigerd",
    sortBy: "Sorteer",
    sortRecommended: "Aanbevolen",
    sortDistance: "Dichtstbij",
    sortRating: "Best beoordeeld",
    sortDiscount: "Grootste korting",
    sortNextSlot: "Volgende slot",
    filterDiscount: "Alleen met korting",
    filterOpenNow: "Slot vandaag",
    kmAway: "km",
    mAway: "m",
    promoCode: "Promocode",
    ...
    apply: "Toepassen",
    remove: "Verwijderen",
    promoApplied: "Code toegepast",
    promoInvalid: "Ongeldige code",
    referralTitle: "Nodig een vriend uit",
    referralBlurb: "Deel je code. Zij krijgen 10% korting op hun eerste bestelling.",
    yourCode: "Jouw code",
    copy: "Kopieer",
    copied: "Gekopieerd",
